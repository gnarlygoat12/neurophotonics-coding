...
spks_real = np.load("/projectnb2/npcr25/projects/two_photon/Ex1_jRGECO1a_ResonantScanning/Suite2P-inferred-spikes/TSeries-03042024-run02-054/spks.npy")  # the *real* Suite2p inference, not the zeroed copy in data_dir
